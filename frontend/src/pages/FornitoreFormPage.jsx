...
const FornitoreFormPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEdit) {
        await api.put(`/anagrafiche/fornitori/${id}`, formData);
      } else {
        await api.post('/anagrafiche/fornitori', formData);
      }
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-6 flex gap-3">
            ...
            >
              {loading ? 'Salvataggio...' : (isEdit ? 'Salva Modifiche' : 'Crea Fornitore')}
            </button>
            <button
              type="button"
...
export default FornitoreFormPage;
